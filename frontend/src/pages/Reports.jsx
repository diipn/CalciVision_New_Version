...
const Reports = () => {
    ...
    return (
        <MainLayout pageTitle="Medical Reports">
            <div className="">
                <h3 className="mb-4 text-2xl font-bold sm:text-3xl">AI Reports</h3>
                <p className="mb-10 text-base sm:text-lg">On this page, you will find patients whose echocardiograms have already been analyzed, but whose reports have not yet been generated with the assistance of AI.
                ...
                <div className="mb-8">
                    ...
                    <div className="w-full overflow-x-auto overscroll-x-contain">
                        <table className="w-full min-w-[760px] table-fixed bg-green-light shadow-md">
                                    ...
                                    patients.map(patient => (
                                        <tr key={patient.id}>
                                            ...
                                            <td className="p-2 text-center">
                                                <div className={`mx-auto w-28 py-[4px] text-sm text-white text-center rounded-md bg-green-600`}>
                                                    {patient.status}
                                                </div>
                                            </td>
                            ...
                            <>
                                <div className="mb-4 space-y-3">
                                    {echoData.map((item, index) => (
                                        <div key={index} className="grid gap-3 rounded bg-white p-4 shadow sm:p-6 md:grid-cols-2 xl:grid-cols-5 xl:items-center">
