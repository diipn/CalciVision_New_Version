    ...
    <nav className="no-scrollbar w-80 h-[var(--content-height)] p-5 bg-green-light border-r-gray-medium border-r-[1px] overflow-auto">
      <ul className="flex flex-col" role='navigation'>
        <ul className="flex flex-col gap-2">
          ...
          <NavItem name="Doentes" url="/patients">
          ...
          <NavItem name="Registos" url="/records">
          ...
          <div className='flex items-center mt-4 pl-2'>
            <small className='text-gray-medium mr-2'>Análise</small>
            <div className='inline-block w-full border-t-[1px] border-gray-medium' />
          </div>
          <ul className='flex flex-col gap-2'>
            <NavItem name="Classificação por IA" url="/select_echo" highlight={true}>
            ...
            <NavItem name="Revisão da análise" url="/analysis_review">
        ...
        <div className='flex items-center mt-4 mb-3 pl-2'>
          <small className='text-gray-medium mr-2'>Utilitários</small>
          <div className='inline-block w-full border-t-[1px] border-gray-medium' />
        </div>
        <ul className='flex flex-col gap-2'>
          <NavItem name="Relatórios IA" url="/reports">
